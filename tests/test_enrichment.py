"""
Automated Pytest for corrected-calcium-calculator Enrichment Modules.
"""
import sys
...
from enrichment import (
    PhosphateBinderOptimizationAndNutritionalPhosphorusTrackingEngine,
    ElectrolyteReplacementProtocolEngine,
    NephrotoxicDrugInteractionAlertingEngine,
    NephrologyConsultAutogenerationEngine,
    CalciumAssessmentEngine,
    BoneMineralMetabolismEngine,
    CurrentManagementEngine,
    RecommendationsEngine,
    CorrectedcalciumcalculatorEnrichmentSuite,
    enrichment_suite,
)

def test_enrichment_suite_execution():
    suite = CorrectedcalciumcalculatorEnrichmentSuite()
