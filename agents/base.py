...
class AuditTrail:
    ...
    def __init__(self, secret_key: Optional[str] = None):
        ...
        if not resolved_key:
            # Generate a cryptographically secure random key per session if none provided.
            # This avoids hardcoding secrets while keeping the audit trail functional in dev.
